...
ssh otto.concord.org "rm /web/geniverse.dev.concord.org/sproutcore/${LABEL}; ln -s /web/geniverse.dev.concord.org/static/lab/en/$(sc-build-number lab) /web/geniverse.dev.concord.org/sproutcore/${LABEL}"
