...
cases << {:hidden_genes=>"{'all': 'm, c, a, b, d, h'}",
  ...
  :pageType=>"chromosomeBreedingPage",
  :match_dragon_alleles=>""}
cases << {:hidden_genes=>"{'female': 'm, c, a, b, d, h, w, fl, hl, t', 'male': 'm, c, a, b, d, h'}",
  :crossover_when_breeding=>true,
...
cases << {:hidden_genes=>"{'all': 'm, c, a, b, d, h'}",
  ...
  :pageType=>"breedingPage",
  :match_dragon_alleles=>""}
cases << {:hidden_genes=>"{'all': 'm, c, a, b, d, h, w, fl, hl, t'}",
  :crossover_when_breeding=>true,
...
cases << {:hidden_genes=>"{'all': 'm, c, a, b, d, h'}",
  ...
  :pageType=>"breedingPage",
  :match_dragon_alleles=>""}
cases << {:hidden_genes=>"{'all': 'm, c, b, d'}",
  :crossover_when_breeding=>true,
...
cases << {:hidden_genes=>"{'all': 'c, b, d, m'}",
  :crossover_when_breeding=>true,
  ...
  :pageType=>"breedingPageGroup",
  :match_dragon_alleles=>""}
cases << {:hidden_genes=>"{'all': 'c, a, b, h, w, fl, hl, t'}",
  :crossover_when_breeding=>false,
  ...
  :pageType=>"chromosomeTrainingPage",
  :match_dragon_alleles=>""}
cases << {:hidden_genes=>"{'all': 'c, b, fl, hl, d, t'}",
  :crossover_when_breeding=>true,
  ...
  :pageType=>"chromosomeTrainingPage",
  :match_dragon_alleles=>""}
cases << {:hidden_genes=>"{'all': 'm, c, d, fl, hl, t'}",
  :crossover_when_breeding=>true,
  ...
  :pageType=>"chromosomeTrainingPage",
  :match_dragon_alleles=>""}
cases << {:hidden_genes=>"{'all': 'w, h, c, a, d, fl, hl, t'}",
  :crossover_when_breeding=>true,
  ...
  :pageType=>"chromosomeTrainingPage",
  :match_dragon_alleles=>""}
cases << {:hidden_genes=>"{'all': 'm, c, a, b, d'}",
  :crossover_when_breeding=>false,
...
Rake.application["db:setup".to_sym].enhance do
  Rake.application["app:setup".to_sym].execute
end
