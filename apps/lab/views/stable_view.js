...
/** @scope Lab.StableView.prototype */ {
  ...
  //titlePath: '',
  /**
   * Binding Path for the content property of the StableView
   */
  contentPath: 'Geniverse.stableOrganismsController.arrangedObjects',
  /**
   * Binding Path for the selection property of the StableView
   */
  selectionPath: 'Geniverse.stableOrganismsController.selection',
  /**
   * Binding Path for the autoScrollTrigger property of the StableView
   */
  autoScrollTriggerPath: 'Geniverse.stableOrganismsController.length',
