// ==========================================================================
// Project:   Geniverse - experiment2 page
...
Lab.experiment2 = SC.Page.design({

  pagePath: 'Lab.experiment2',
  title: 'In the Clutches of Drakes | Geniverse',
  ...
  mainPane: SC.MainPane.design({
    ...
    topBar: Lab.TopBarView.design({
      titlePath: 'Lab.experiment2.title'
    }),
    ...
    mainAppView: SC.View.design({
      ...
      background: SC.ImageView.design({
        ...
        value: static_url('experiment-bg2.jpg')
      }),
