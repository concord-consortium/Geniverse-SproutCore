...
Lab.breedingPageMatch = SC.Page.design({
  ...
  mainPane: SC.MainPane.design({
    ...
    mainAppView: SC.View.design({
      ...
      layout: { centerX: 0, top: 32, width: 900, height: 676 },
      ...
      breedView: Geniverse.BreedDragonView.design({
        layout: { top: 3 , left: 110, height: 330, right: 110 },
      ...
      breedingPenView: Lab.BreedingPenView.design({
        layout: { centerX: 0, top: 42, width: 325, height: 426 }
      }),

      stableView: Lab.StableView.design({
        layout: { centerX: 0, top: 578, width: 520, height: 97 }
      }),
      
      matchView: Geniverse.MatchView.design({
        layout: { centerX: 0, top: 458, width: 410, height: 117 },
        dragonSize: 96
      }),
