...
Lab.invisibleFemaleGenotypePage = SC.Page.design({
  pagePath: 'Lab.invisibleFemaleGenotypePage',
    ...
    mainAppView: SC.View.design({
      ...
      genomePanel: SC.View.design({
        ...
        femalePhenotypeView: Geniverse.OrganismView.design({
          ...
          contentBinding: "Geniverse.challengePoolController.firstFemale",
          allowDrop: NO,
          showBackground: NO,
          glow: YES,
        ...
        femaleGenomeView: Lab.InvisibleGenomeView.design({
          layout: {top: 170, left: -105, height: 500, width: 500 },
          sex: 1,
          index: 1
        }),
        ...
        maleGenomeView: Lab.DragonBreedingGenomeView.design({
          layout: {top: 170, right: 100+0, height: 500, width: 500 },
          sex: 0,
          index: 2,
          dragonOnRight: YES
        }),
