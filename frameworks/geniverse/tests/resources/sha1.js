...
// ************** Code below copied from sha1.js **************
...
function SHA_1_sha1Hash(msg)
{
    ...
    for (var i=0; i<N; i++) {
        ...
        for (var t=16; t<80; t++) W[t] = SHA_1_ROTL(W[t-3] ^ W[t-8] ^ W[t-14] ^ W[t-16], 1);
        ...
        for (var t=0; t<80; t++) {
            ...
            var T = (SHA_1_ROTL(a,5) + SHA_1_f(s,b,c,d) + e + K[s] + W[t]) & 0xffffffff;
            e = d;
            d = c;
            c = SHA_1_ROTL(b, 30);
            b = a;
